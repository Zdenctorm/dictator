...
| [sources/](./sources/) | HTML zálohy článků, URL seznamy, manifest |
| [scripts/download-assets.sh](./scripts/download-assets.sh) | Opakovatelné stažení |

**Rychlý start:** otevři `screenshots/whispur/recording-overlay.png` a `whispur/settings-setup.png`.
