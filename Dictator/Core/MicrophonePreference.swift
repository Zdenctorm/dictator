...
enum MicrophonePreference {
    ...
    static var selectedDeviceUID: String? {
        ...
        set {
            ...
            NotificationCenter.default.post(name: .dictatorMicrophonePreferenceChanged, object: nil)
        }
    }
...
extension Notification.Name {
    static let dictatorMicrophonePreferenceChanged = Notification.Name("DictatorMicrophonePreferenceChanged")
}
