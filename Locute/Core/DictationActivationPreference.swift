...
enum DictationActivationMode: String, CaseIterable, Sendable {
    ...
    var label: String {
        switch self {
        case .pushToTalk: return "Drž a pusť (doporučeno)"
...
enum DictationActivationPreference {
    ...
    static var current: DictationActivationMode {
        ...
        set {
            ...
            NotificationCenter.default.post(name: .locuteActivationModeChanged, object: nil)
        }
    }
}

extension Notification.Name {
    static let locuteActivationModeChanged = Notification.Name("LocuteActivationModeChanged")
}
